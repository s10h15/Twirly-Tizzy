...
import { normalIsCollidesCircle, normalIsPointInside, normalRecenterVertexes } from "../Helpers/collision.js";
import { drawEquipableObject } from "../Helpers/repetitiveDraws.js";

export function getHook(vertexes, images) {
    const hook = {
        vertexes: vertexes,
        name: "hook",
        ...
        textureWidth: 0,
        textureHeight: 0,
        imageToUseInTexture: images.hook ?? null,
        numToGive: 1,
        ...
        use(player, gameStepsCount, world, images, camera, console) {
            if (player.isDead || world.objects.fires[0].remainingStrength <= 0) {
                return false;
            } else {
                player.hookTo(0, 0);
                return true;
