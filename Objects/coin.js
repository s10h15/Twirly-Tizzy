...
import { closestSegmentPoint, normalRecenterVertexes, normalIsCollidesCircle, normalIsPointInside } from "../Helpers/collision.js";
import { drawEquipableObject } from "../Helpers/repetitiveDraws.js";

export function getCoin(vertexes, images, quantity = 1) {
    const coin = {
        vertexes: vertexes,
        name: "coin",
        ...
        textureWidth: 0,
        textureHeight: 0,
        imageToUseInTexture: images.coin ?? null,
        numToGive: quantity,
