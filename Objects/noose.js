...
export function getNoose(vertexes, images) {
    const noose = {
        vertexes: vertexes,
        name: "noose",
        ...
        textureWidth: 0,
        textureHeight: 0,
        imageToUseInTexture: images.noose ?? null,
        numToGive: 1,
        ...
        use(player, gameStepsCount, world, images, camera, console) {
            player.isDead = true;
            console.addMessage("Никогда не поздно покончить с собой", 3000, "white");
            return true;
        }
    }
    noose.updateCenter();
    noose.generateTexture();
    return noose;
}